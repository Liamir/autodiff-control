"""Compare dopri5 (PyTorch vs JAX) vs Kvaerno5 with horizon=50."""
import time
import torch
import jax
...
def main():
    """Compare dopri5 (PyTorch vs JAX) and Kvaerno5 with horizon=50."""
    print("="*80)
    print("COMPARISON: dopri5 (PyTorch vs JAX) vs Kvaerno5")
    print("="*80)
    print("HPA System: FULL HORIZON=50 days, 101 time points")
    print()
    ...
    time_horizon = 50.0  # FULL HORIZON
    n_reward_steps = 100
    ...
    # Summary
    print("\n" + "="*80)
    print("SUMMARY TABLE (horizon=50 days)")
    print("="*80)
    ...
    if successful:
        ...
        if pytorch_result and pytorch_result['success']:
            ...
            print(f"    PyTorch: {pt_time/60:.1f} minutes")
            print(f"    {fastest['name']}: {jax_time/60:.1f} minutes")
